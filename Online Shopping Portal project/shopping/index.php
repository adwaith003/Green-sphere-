...
<html lang="en">
	<head>
      ...
      <div>
		...
		<a href="assets/images/sliders/5.jpg"><i class="image"></i></a>
      </div>
    ...
    <body class="cnt-home">
		<!-- ************************************************************************************************************** -->
		<!-- <section class="u-align-center u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-dialog-section-12" id="carousel_6507" data-dialog-show-on="timer" data-dialog-show-on-list="693625935" data-dialog-show-interval="1000">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All items of high quality</h6>	
				</div>
			</div> 
		</div>
	</div>
